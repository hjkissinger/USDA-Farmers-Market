---
title: "USDA Farmers Market Registrations Post-Pandemic: Transitioning to Online Directories R-Documentation"
...
Download tidyverse and upload data file
```{r}
library(tidyverse)
...
Continue cleaning data in Google Sheets (see Changelog)
